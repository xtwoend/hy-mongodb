...
use Xtwoend\HyMongo\Relations\HasOne;
use Xtwoend\HyMongo\Relations\HasMany;
use Xtwoend\HyMongo\Relations\MorphTo;
use Xtwoend\HyMongo\Relations\BelongsTo;
use Xtwoend\HyMongo\Relations\MorphMany;
use Xtwoend\HyMongo\Relations\BelongsToMany;
use Hyperf\Database\Model\Relations\MorphOne;
use Xtwoend\HyMongo\Relations\EloquentBuilder;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (! is_subclass_of($related, \Xtwoend\HyMongo\Model\Model::class)) {
    ...
    {
        if (is_subclass_of($this, \Xtwoend\HyMongo\Model\Model::class)) {
